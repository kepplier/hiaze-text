...
local RayfieldFolder = "Aeolus"
local ConfigurationFolder = RayfieldFolder.."/Configurations"
local ConfigurationExtension = ".rfld"
local settingsTable = {
	General = {
		-- if needs be in order just make getSetting(name)
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Aeolus Keybind'},
		-- buildwarnings
		-- rayfieldprompts
...
local Rayfield = useStudio and script.Parent:FindFirstChild('Aeolus') or game:GetObjects("rbxassetid://108031440")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Aeolus') or game:GetObjects("rbxassetid://10831440")[1]
